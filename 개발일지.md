...
2. 메인페이지 합치기( 조인태, 김효진, 이가희)
   ...
   <img src="./images/메인페이지.gif" width="800px;" height="400px">
...
1. story bar 구현
   ...
   <img src="./images/story.gif" width="800px;" height="400px">
...
1. 메인 화면 - 상단바
   ...
   <img src="./images/nav bar.gif" width="800px;">
...
1. 게시판 - 전체 통합
   ...
   <img src="./images/게시글전체.gif" width="800px;">
...
1. 권용 - _안드로이드 로그인 페이지_
   ...
   <img src="./images/코드리뷰/20200831코드리뷰(권용).PNG" width="800px;">
...
2. 조인태 - _게시글 HTML/CSS/JavaScript_
   ...
   <img src="./images/코드리뷰/20200831코드리뷰(조인태).PNG" width="800px;">

부족한 점

   1. 슬라이드 버튼이 이미지가 처음이면 왼쪽 버튼이 없어지고 끝이면 오른쪽 버튼이 없어지는 기능을 추가 구현해야한다.
   2. 이미지를 background-image 미리 3가지 다 load한 상태에서 진행하기 때문에 메모리가 비효율적이다. canvas를 공부하여 이미지를 버튼 클릭 시 load 하는 방향으로 수정해야한다.(canvas는 새로운 이미지가 불러올때 그려지기 때문에 메모리가 효율적일 것 같다.)
...
1. 김효진 - _스토리 HTML/CSS/JS_
   ...
   <img src="./images/코드리뷰/20200903코드리뷰(김효진).PNG" width="800px;">

부족한 점

   1. 적어주세요

2. 이가희 - _상단바 + 사이드바 HTML/CSS/JS_

   <img src="./images/코드리뷰/20200903코드리뷰(이가희).PNG" width="800px;">   
